...
export default defineConfig({
  // React (JSX/Fast-Refresh) + Tailwind v4 (CSS-first, no PostCSS). The client
  // UI is React rendered into the existing WindowManager windows; the Canvas
  // Renderer stays outside React. See client/src/index.css for the Tailwind entry.
